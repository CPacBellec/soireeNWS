...
// Préparation et exécution de la requête préparée
$query = $pdo->prepare("INSERT INTO scroll_tracking (user_id, scroll_position, section_name) VALUES (?, ?, ?)");
$query->execute([$user_id, $scroll_position, $section_name]);
